...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_basic_recipe(self):
        ...
        for key in payload.keys():
            ...
            # getattr(recipe, key)=recipe.value of key
    ...
    def test_recipe_with_tags(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
        tags = recipe.tags.all()  # returns all tags of the recipe
    ...
    def test_recipe_with_ingredients(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
        ingredients = recipe.ingredients.all()  # returns all tags of the recipe
